...
async function save(t) {
  ...
  if (isSlideshow && (t === 'PRG' || t === 'CRT')) {
    ...
    const code = [
      ...
      0xA9,0x18,0x8D,0x18,0xD0,0xA9,0x00,0x85,0x02,0xA6,0x02,0xBD,0xB0,0x08,0x85,0xFB,
      0xA9,0x00,0x85,0xFA,0xA9,0x20,0x85,0xFD,0xA9,0x00,0x85,0xFC,0xA2,0x20,0x20,0x97,0x08,
      0xA9,0x04,0x85,0xFD,0xA9,0x00,0x85,0xFC,0xA2,0x04,0x20,0x97,0x08,
      0xA9,0xD8,0x85,0xFD,0xA9,0x00,0x85,0xFC,0xA2,0x04,0x20,0x97,0x08,
      0xA6,0x02,0xBD,0xC0,0x08,0x8D,0x20,0xD0,0x8D,0x21,0xD0,0xBD,0xD0,0x08,0x8D,0x16,0xD0,
      0xAD,0x01,0xDC,0xC9,0xFF,0xD0,0x0A,0xAD,0x00,0xDC,0xC9,0xFF,0xD0,0x03,0x4C,0x69,0x08,
      0xAD,0x01,0xDC,0xC9,0xFF,0xD0,0xF9,0xAD,0x00,0xDC,0xC9,0xFF,0xD0,0xF2,
      0xE6,0x02,0xA5,0x02,0xC9, num, 0xD0,0x04,0xA9,0x00,0x85,0x02,0x4C,0x26,0x08,
      0xA0,0x00,0xB1,0xFA,0x91,0xFC,0xC8,0xD0,0xF9,0xE6,0xFB,0xE6,0xFD,0xCA,0xD0,0xF2,0x60
    ];
