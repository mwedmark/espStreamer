...
<div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; padding: 20px 0; align-items: start; justify-items: center;">

  <a href="images/CartoonCar.webp" target="_blank">
    <img src="images/CartoonCar.webp" alt="CartoonCar" width="260" style="border: 1px solid #ccc; border-radius: 4px;" />
  </a>
   <a href="images/CombinedWebApp&VICE.webp" target="_blank">
    <img src="images/CombinedWebApp&VICE.webp" alt="CartoonCar" width="260" style="border: 1px solid #ccc; border-radius: 4px;" />
  </a>
   <a href="images/EarlySettingsHR.webp" target="_blank">
    <img src="images/EarlySettingsHR.webp" alt="EarlySettingsHR.webp" width="260" style="border: 1px solid #ccc; border-radius: 4px;" />
  </a>
   <a href="images/EarlySettingsMC.webp" target="_blank">
    <img src="images/EarlySettingsMC.webp" alt="EarlySettingsMC.webp" width="260" style="border: 1px solid #ccc; border-radius: 4px;" />
  </a>
   <a href="images/Earlyimage.webp" target="_blank">
    <img src="images/Earlyimage.webp" alt="Earlyimage.webp" width="260" style="border: 1px solid #ccc; border-radius: 4px;" />
  </a>
   <a href="images/Earlyimage2.webp" target="_blank">
    <img src="images/Earlyimage2.webp" alt="Earlyimage2.webp" width="260" style="border: 1px solid #ccc; border-radius: 4px;" />
  </a>
   <a href="images/FiatEarlyIFLI.webp" target="_blank">
    <img src="images/FiatEarlyIFLI.webp" alt="FiatEarlyIFLI.webp" width="260" style="border: 1px solid #ccc; border-radius: 4px;" />
  </a>
   <a href="images/FirstColorImage.webp" target="_blank">
    <img src="images/FirstColorImage.webp" alt="FirstColorImage.webp" width="260" style="border: 1px solid #ccc; border-radius: 4px;" />
  </a>
   <a href="images/FirstWorkingPRG.webp" target="_blank">
    <img src="images/FirstWorkingPRG.webp" alt="FirstWorkingPRG.webp" width="260" style="border: 1px solid #ccc; border-radius: 4px;" />
  </a>
   <a href="images/ForzaFullScreen.webp" target="_blank">
    <img src="images/ForzaFullScreen.webp" alt="ForzaFullScreen.webp" width="260" style="border: 1px solid #ccc; border-radius: 4px;" />
  </a>
   <a href="images/KoalaViewerDemo.webp" target="_blank">
    <img src="images/KoalaViewerDemo.webp" alt="KoalaViewerDemo.webp" width="260" style="border: 1px solid #ccc; border-radius: 4px;" />
  </a>
   <a href="images/MonsterEarlyIFLI.webp" target="_blank">
    <img src="images/MonsterEarlyIFLI.webp" alt="MonsterEarlyIFLI.webp" width="260" style="border: 1px solid #ccc; border-radius: 4px;" />
  </a>
   <a href="images/PassatBW.webp" target="_blank">
    <img src="images/PassatBW.webp" alt="PassatBW.webp" width="260" style="border: 1px solid #ccc; border-radius: 4px;" />
  </a>
   <a href="images/SUVImage.webp" target="_blank">
    <img src="images/SUVImage.webp" alt="SUVImage.webp" width="260" style="border: 1px solid #ccc; border-radius: 4px;" />
  </a>
   <a href="images/SwedishLiveTV.webp" target="_blank">
    <img src="images/SwedishLiveTV.webp" alt="SwedishLiveTV.webp" width="260" style="border: 1px solid #ccc; border-radius: 4px;" />
  </a>
   <a href="images/Tiger.webp" target="_blank">
    <img src="images/Tiger.webp" alt="Tiger.webp" width="260" style="border: 1px solid #ccc; border-radius: 4px;" />
  </a>
   <a href="images/Volvo240EarlyFLI.webp" target="_blank">
    <img src="images/Volvo240EarlyFLI.webp" alt="Volvo240EarlyFLI.webp" width="260" style="border: 1px solid #ccc; border-radius: 4px;" />
  </a>
   <a href="images/imageCarBWDither.webp" target="_blank">
    <img src="images/imageCarBWDither.webp" alt="imageCarBWDither.webp" width="260" style="border: 1px solid #ccc; border-radius: 4px;" />
  </a>
    <a href="images/imageCarColorDither.webp" target="_blank">
    <img src="images/imageCarColorDither.webp" alt="imageCarColorDither.webp" width="260" style="border: 1px solid #ccc; border-radius: 4px;" />
   </a>
    <a href="images/imageVICE.webp" target="_blank">
    <img src="images/imageVICE.webp" alt="imageVICE.webp" width="260" style="border: 1px solid #ccc; border-radius: 4px;" />
   </a>
    <a href="images/imageWeb.webp" target="_blank">
    <img src="images/imageWeb.webp" alt="imageWeb.webp" width="260" style="border: 1px solid #ccc; border-radius: 4px;" />
  </a>
</div>
### How to add images:
