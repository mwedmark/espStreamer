            ...
            for (let cy = 0; cy < 25; cy++) {
                for (let cx = 0; cx < 40; cx++) {
                    ...
                    if (isF) {
                        ...
                        // This is what makes FLI actually produce per-scanline palette switching.
                        ...
                        // Store best per-scanline c1/c2 for each cC candidate
                        ...
                        for (let candCC = 0; candCC < 16; candCC++) {
                            ...
                            for (let py = 0; py < 8; py++) {
                                // Count colors on this scanline, excluding bg and candCC
                                ...
                                // Calculate total error for this scanline with palette {bg, c1, c2, candCC}
                                for (let px = 0; px < 4; px++) {
                                    const ri = (py * 4 + px) * 3;
                        ...
                        // Write Screen RAM and Bitmap for each scanline using the best palette
                        for (let py = 0; py < 8; py++) {
