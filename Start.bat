...
start /b "" "!VLC!" screen:// :screen-fps=20 :screen-caching=0 :live-caching=0 :screen-top=0 :screen-left=0 :screen-width=%SCREEN_W% :screen-height=%SCREEN_H% :sout=#transcode{vcodec=mjpg,vb=2000,width=320,height=200,fps=20}:standard{access=http,mux=mpjpeg,dst=:90/pc.mjpg} :sout-keep
