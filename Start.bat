...
start /b "" "!VLC!" screen:// :screen-fps=30 :screen-caching=0 :live-caching=0 :screen-top=0 :screen-left=0 :screen-width=%SCREEN_W% :screen-height=%SCREEN_H% :sout=#transcode{vcodec=mjpg,vb=1200,width=160,height=200,fps=30}:standard{access=http,mux=mpjpeg,dst=:90/pc.mjpg} :sout-keep
